    ...
    <header className="sticky top-0 z-50 border-b border-[#e6edf6] bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-22 w-full max-w-[1240px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <span className={`${rubik.className} text-[26px] font-semibold tracking-[0.16em] text-[#0E51A0]`}>
            TALKINGHEADS SALES TRAINER
          </span>
        </div>

        <nav className="hidden items-center gap-14 lg:flex">
          <a href="#vorteile" className="text-[28px] font-medium text-[#1b2b45] hover:text-[#0E51A0]">
            Vorteile
          </a>
          <a href="#fuer-wen" className="text-[28px] font-medium text-[#1b2b45] hover:text-[#0E51A0]">
            Für wen
          </a>
          <a href="#so-funktionierts" className="text-[28px] font-medium text-[#1b2b45] hover:text-[#0E51A0]">
            So funktioniert&apos;s
          </a>
        </nav>
...
function BenefitCard({ title, text }: { title: string; text: string }) {
  return (
    <article className="rounded-2xl border border-[#dce7f7] bg-white p-7 shadow-[0_10px_22px_rgba(14,81,160,0.08)]">
      ...
      <h3 className={`${rubik.className} text-[38px] font-semibold leading-[1.1] text-[#0E51A0]`}>{title}</h3>
      <p className="mt-4 text-[35px] leading-[1.45] text-[#3f4d63]">{text}</p>
    </article>
  );
}
...
function AudienceCard({ title, text }: { title: string; text: string }) {
  return (
    <article className="rounded-2xl border border-[#dce7f7] bg-white p-7 shadow-[0_10px_22px_rgba(14,81,160,0.08)]">
      ...
      <h3 className={`${rubik.className} text-[40px] font-semibold leading-[1.15] text-[#0E51A0]`}>{title}</h3>
      <p className="mt-4 text-[34px] leading-[1.45] text-[#3f4d63]">{text}</p>
    </article>
  );
}
    ...
    <main className={`${roboto.className} bg-[#f5f7fa] text-[#1b2b45]`}>
      ...
      <section className="mx-auto w-full max-w-[1240px] px-4 pb-12 pt-8 sm:px-6 lg:px-8 lg:pb-14 lg:pt-10">
        <div className="grid items-stretch gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          >
            <h1 className={`${rubik.className} text-balance text-[78px] font-bold leading-[1.02]`}>
              Mehr Sales.
              <br />
              Mehr Abschlüsse.
              <br />
            ...
            <p className="mt-6 max-w-3xl text-[33px] leading-[1.35] text-[#dce8fb]">
      ...
      <section id="fuer-wen" className="mx-auto w-full max-w-[1240px] px-4 py-10 sm:px-6 lg:px-8">
        <h2 className={`${rubik.className} text-center text-[54px] font-bold text-[#0E51A0]`}>
      ...
      <section id="so-funktionierts" className="mx-auto w-full max-w-[1240px] px-4 pb-14 pt-4 sm:px-6 lg:px-8 lg:pb-16">
        <div className="rounded-[1.8rem] bg-[linear-gradient(145deg,#0E51A0,#1b61b8)] px-8 py-10 text-center shadow-[0_24px_44px_rgba(14,81,160,0.28)] sm:px-10">
          <h2 className={`${rubik.className} text-[58px] font-bold leading-[1.08] text-white`}>
            Bereit, Verkauf wirklich zu trainieren?
          </h2>
          <p className="mx-auto mt-4 max-w-5xl text-[32px] leading-[1.35] text-[#dce8fb]">
