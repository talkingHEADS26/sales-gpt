-- Remove manual activation requirement for organization_signup.
-- Previously new org admins were created with is_active = false and required
-- manual approval. They are now activated immediately on registration.
...
-- Also activate any existing profiles that are inactive due to the old requirement.
